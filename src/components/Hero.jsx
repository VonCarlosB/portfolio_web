export default function Hero(){
    return(
        <section id="home" className="py-16 text-center">
            <h1 className="text-4xl sm:text-5xl font-extrabold">Carlos — Desarrollador Web Frontend</h1>
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Transformo ideas en interfaces usables y limpias.</p>
